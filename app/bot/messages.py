...
TRANSLATIONS: dict[str, TemplateMap] = {
    "en": {
        ...
        "admin_offer_link_select_tour": "Select tour #{tour_id}",
        "admin_offer_link_search": "Search compatible tours",
        "admin_offer_link_search_prompt": "Send tour code or part of code for offer #{offer_id}. Search stays limited to compatible tours.",
        "admin_offer_link_search_results_title": "Compatible tour code search results for offer #{offer_id} ({mode}) — \"{query}\" — page {page}:",
        "admin_offer_link_search_empty": "No compatible tours found for code \"{query}\". No link was changed.",
