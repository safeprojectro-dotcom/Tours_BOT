...
TRANSLATIONS: dict[str, TemplateMap] = {
    "en": {
        ...
        "admin_offer_ow_exec_link_confirm_question": "Create or update the active execution link so /start supoffer routes to this Tour? Uses the linked tour from the offer card (same as HTTP POST …/execution-link). Requires a published offer.",
    ...
    "ro": {
        ...
        "admin_offer_ow_exec_link_confirm_question": "Creăm sau actualizăm linkul activ de execuție ca /start supoffer să ducă la acest tur? Folosește turul legat din card (același apel ca HTTP POST …/execution-link). Cere ofertă publicată.",
