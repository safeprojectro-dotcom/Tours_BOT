...
TRANSLATIONS: dict[str, TemplateMap] = {
    "en": {
        ...
        "admin_offer_operator_workflow_header": "— Operator workflow (review-package) —",
        "admin_offer_operator_workflow_state": "State: {state}",
        "admin_offer_operator_workflow_next_primary": "Next: {code} — {label} · danger={danger} · confirm={confirm}",
        "admin_offer_operator_workflow_endpoint_hint": "Hint: {method} {endpoint}",
        "admin_offer_operator_workflow_next_code": "Next: {code}",
        "admin_offer_operator_workflow_next_none": "Next: —",
        "admin_offer_operator_workflow_blocking_title": "Blocking:",
        "admin_offer_operator_workflow_warnings_title": "Workflow warnings:",
        "admin_offer_operator_workflow_footer": "Read-only hints from Admin GET …/review-package — run POST/GET actions outside Telegram.",
        "admin_offer_operator_workflow_public_danger_note": "⚠ Public/channel-visible step — confirm before running outside Telegram.",
    ...
    "ro": {
        ...
        "admin_offer_operator_workflow_header": "— Flux operator (review-package) —",
        "admin_offer_operator_workflow_state": "Stare: {state}",
        "admin_offer_operator_workflow_next_primary": "Următor: {code} — {label} · danger={danger} · confirm={confirm}",
        "admin_offer_operator_workflow_endpoint_hint": "Indiciu: {method} {endpoint}",
        "admin_offer_operator_workflow_next_code": "Următor: {code}",
        "admin_offer_operator_workflow_next_none": "Următor: —",
        "admin_offer_operator_workflow_blocking_title": "Blocaje:",
        "admin_offer_operator_workflow_warnings_title": "Avertismente flux:",
        "admin_offer_operator_workflow_footer": "Indicii read-only din Admin GET …/review-package — rulează POST/GET în afara Telegram.",
        "admin_offer_operator_workflow_public_danger_note": "⚠ Pas vizibil public/pe canal — confirmă înainte de a rula în afara Telegram.",
