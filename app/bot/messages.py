...
TRANSLATIONS: dict[str, TemplateMap] = {
    "en": {
        ...
        "supplier_offer_prompt_base_price": "Send base price (number, e.g. 120.00).",
        "supplier_offer_prompt_currency": "Send currency code (e.g. EUR).",
        ...
        "supplier_offer_opt_payment_assisted_closure": "Assisted closure",
        ...
        "supplier_offer_invalid_datetime": "Could not parse date/time. Use YYYY-MM-DD HH:MM.",
        ...
        "supplier_offer_invalid_currency": "Currency code is required.",
    ...
    "ro": {
        ...
        "supplier_offer_prompt_base_price": "Trimite prețul de bază (număr, ex. 120.00).",
        "supplier_offer_prompt_currency": "Trimite codul valutei (ex. EUR).",
        ...
        "supplier_offer_opt_payment_assisted_closure": "Închidere asistată",
        ...
        "supplier_offer_invalid_datetime": "Nu am putut interpreta data/ora. Folosește AAAA-LL-ZZ HH:MM.",
        ...
        "supplier_offer_invalid_currency": "Codul valutei este obligatoriu.",
