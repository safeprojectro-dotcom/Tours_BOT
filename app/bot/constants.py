...
SUPPLIER_OFFER_SCHEDULE_CALLBACK_PREFIX = "supplier:offer:schedule:"
SUPPLIER_OFFER_SCHEDULE_ONE = "supplier:offer:schedule:one_trip"
SUPPLIER_OFFER_SCHEDULE_RECURRING = "supplier:offer:schedule:recurring"
SUPPLIER_OFFER_COVER_CALLBACK_PREFIX = "supplier:offer:cover:"
SUPPLIER_OFFER_COVER_URL = "supplier:offer:cover:url"
SUPPLIER_OFFER_COVER_NONE = "supplier:offer:cover:none"
# Stored in offer.cover_media_reference; bot can re-fetch file via getFile(file_id) later. Do not use as a public URL.
SUPPLIER_OFFER_COVER_TELEGRAM_PHOTO_PREFIX = "telegram_photo:"
...
# Slice C2B10T-A: create_tour_bridge (operator_workflow) propose / confirm / cancel
ADMIN_OPS_OW_TOUR_BRIDGE_PROPOSE_PREFIX = "ao:ow:tbp:"
ADMIN_OPS_OW_TOUR_BRIDGE_CONFIRM_PREFIX = "ao:ow:tbc:"
ADMIN_OPS_OW_TOUR_BRIDGE_CANCEL_PREFIX = "ao:ow:tbx:"
# Slice C2B10T-B: activate_tour_for_catalog (operator_workflow) propose / confirm / cancel
