...
class AdminRouteTests(FoundationDBTestCase):
    ...
    def test_admin_ops_orders_list_all_users_while_mini_app_bookings_stay_user_scoped(self) -> None:
        ...
        self.assertIsNotNone(row_a.get("customer_summary"))
        self.assertEqual(row_a["customer_summary"]["display_name"], "Test User")
        self.assertIn("Test User", row_a["customer_summary"]["summary_line"])
        ...
        dj = detail.json()
        self.assertEqual(dj["customer_telegram_user_id"], 351_002)
        self.assertIsNotNone(dj.get("customer_summary"))
        self.assertEqual(dj["customer_summary"]["display_name"], "Test User")
    ...
    def test_admin_ops_custom_requests_list_all_users_while_my_requests_stay_user_scoped(self) -> None:
        ...
        self.assertIsNotNone(body["request"].get("customer_summary"))
        self.assertEqual(body["request"]["customer_summary"]["display_name"], "Test User")
