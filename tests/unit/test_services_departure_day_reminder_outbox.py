...
from app.workers.departure_day_reminder_outbox import run_once
from tests.unit.base import FoundationDBTestCase


class DepartureDayReminderOutboxServiceTests(FoundationDBTestCase):
    def test_enqueue_due_reminders_persists_due_departure_day_reminder_once(self) -> None:
        ...
        self.create_translation(tour, language_code="ro", title="Belgrad Azi Outbox")
        ...
        self.create_payment(order, external_payment_id="day-outbox", status=PaymentStatus.PAID)

        service = DepartureDayReminderOutboxService()
    ...
    def test_worker_run_once_delegates_to_outbox_service(self) -> None:
        ...
        with patch("app.workers.departure_day_reminder_outbox.DepartureDayReminderOutboxService") as service_cls:
