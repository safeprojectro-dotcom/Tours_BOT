...
**B16 Step 1 (done):** Read-only **`GET /admin/ops-dashboard`** — **[`docs/B16_ADMIN_OPS_VISIBILITY_READ_DASHBOARD.md`](B16_ADMIN_OPS_VISIBILITY_READ_DASHBOARD.md)** — **`summary`**, **`attention_items`**, **`recent_orders`**, **`upcoming_tours`**, **`recent_publications`**, **`conversion_links`**, **`generated_at`**, **`audit_hint`**; existing admin token auth. **Tests:** **`tests/unit/test_admin_ops_dashboard.py`** **4 passed**; with **`test_admin_publishing_console.py`** **12 passed.** **No** mutation, **no** Telegram, **no** Layer A changes, **no** Mini App routing changes. **Next:** **B16B** filters/pagination/time-window or **B16C** detail navigation — **[`docs/HANDOFF_B16_ADMIN_OPS_VISIBILITY_READ_DASHBOARD_TO_NEXT_STEP.md`](HANDOFF_B16_ADMIN_OPS_VISIBILITY_READ_DASHBOARD_TO_NEXT_STEP.md)**.

**B16D (design only — no implementation):** Guarded OPS automation levels and future **`prepare_conversion_chain`** — **[`docs/B16D_OPS_ACTIONS_GUARDED_AUTOMATION_DESIGN.md`](B16D_OPS_ACTIONS_GUARDED_AUTOMATION_DESIGN.md)**. Public **`publish_showcase_channel`** remains a **separate**, **confirmation-gated** action. **Recommended before execution slices:** **B16B** / **B16C** — handoff **[`docs/HANDOFF_B16D_OPS_ACTIONS_GUARDED_AUTOMATION_DESIGN_TO_NEXT_STEP.md`](HANDOFF_B16D_OPS_ACTIONS_GUARDED_AUTOMATION_DESIGN_TO_NEXT_STEP.md)**.
...
- **B16 Step 1 (implemented):** **`GET /admin/ops-dashboard`** read-only OPS dashboard — **[`docs/B16_ADMIN_OPS_VISIBILITY_READ_DASHBOARD.md`](B16_ADMIN_OPS_VISIBILITY_READ_DASHBOARD.md)**; **tests** **`tests/unit/test_admin_ops_dashboard.py`** **4** **passed**; **handoff** **[`docs/HANDOFF_B16_ADMIN_OPS_VISIBILITY_READ_DASHBOARD_TO_NEXT_STEP.md`](HANDOFF_B16_ADMIN_OPS_VISIBILITY_READ_DASHBOARD_TO_NEXT_STEP.md)**; **forward** **B16B**–**B16E** per handoff.
