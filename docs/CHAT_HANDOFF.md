...
**B16D (design only — no implementation):** Guarded OPS automation levels and future **`prepare_conversion_chain`** — **[`docs/B16D_OPS_ACTIONS_GUARDED_AUTOMATION_DESIGN.md`](B16D_OPS_ACTIONS_GUARDED_AUTOMATION_DESIGN.md)**. Public **`publish_showcase_channel`** remains a **separate**, **confirmation-gated** action. **Recommended before execution slices:** **B16D1** (read-only action plan preview) — handoff **[`docs/HANDOFF_B16D_OPS_ACTIONS_GUARDED_AUTOMATION_DESIGN_TO_NEXT_STEP.md`](HANDOFF_B16D_OPS_ACTIONS_GUARDED_AUTOMATION_DESIGN_TO_NEXT_STEP.md)**.
...
- **B16 Step 1** **+** **B16B** **+** **B16C** **(** **implemented** **):** **[`docs/B16_ADMIN_OPS_VISIBILITY_READ_DASHBOARD.md`](B16_ADMIN_OPS_VISIBILITY_READ_DASHBOARD.md)** — **`GET /admin/ops-dashboard`** read-only OPS dashboard **;** **B16B** **query** **filters** / **limits** / **`include_sections`** / **`filters`** **echo** **;** **B16C** **additive** **`admin_path`** **/** **link** **paths** **for** **dashboard** **rows** **;** **tests** **`tests/unit/test_admin_ops_dashboard.py`** **—** **11** **passed** **(** **with** **`test_admin_publishing_console.py`** **—** **19** **passed** **)** **;** **handoff** **[`docs/HANDOFF_B16_ADMIN_OPS_VISIBILITY_READ_DASHBOARD_TO_NEXT_STEP.md`](HANDOFF_B16_ADMIN_OPS_VISIBILITY_READ_DASHBOARD_TO_NEXT_STEP.md)** **;** **forward** **B16D1**–**B16E** **per** **handoff**.
