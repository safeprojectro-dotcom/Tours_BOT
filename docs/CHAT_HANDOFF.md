...
- **B12/B13.3** **—** **`sendMessage`** **with** **`disable_web_page_preview=True`** **for** **text-only** **showcase** **(no** **Flet/Railway** **link** **preview** **card** **).** **B12/B13.4** **—** **read-only** **admin** **`GET /admin/supplier-offers/{id}/showcase-preview`** **(exact** **`caption_html`** **+** **CTA** **URLs** **+** **flags** **;** **no** **Telegram** **I/O** **).**
