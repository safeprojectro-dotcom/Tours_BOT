...
- **B2 (implementation, completed):** **Migration** **`20260526_24`** **—** **extended** **`supplier_offers`** **columns** **+** **supplier-admin** **/** **admin** **read** **models** **(`AdminSupplierOfferRead`** **for** **admin-only** **metadata)**. **Data** **only** **—** **see** [`HANDOFF_B2_...`](HANDOFF_B2_SUPPLIER_OFFER_CONTENT_DATA_UPGRADE.md). **Next** **safe** **BUSINESS** **implementation** **step:** **B3** **—** **Supplier** **dialog** **upgrade**.
