...
- Y36.1 **Operator assignment** gate is in **`docs/OPERATOR_ASSIGNMENT_GATE.md`**. The implemented and **accepted** slice is **Y36.2** + **Y36.2A** + **Y36.3** + **Y36.4** with **Y36.5** docs acceptance (this file + **`docs/OPEN_QUESTIONS_AND_TECH_DEBT.md`**). **Y36.4** Telegram polish is **shipped/accepted**; **reassign** / **unassign** / **resolve** / **close** are **out of scope** until a **design gate** (not ad hoc).
- **Next safe order:**
  1. **Design gate** (required) before any **reassign** / **unassign** / admin **resolve** or **close** on custom requests beyond current assignment semantics. Suggested follow-on docs: **Y37** operator request workflow gate, or **Y36.6** small formatting (dates / customer summary) if product wants polish only.
