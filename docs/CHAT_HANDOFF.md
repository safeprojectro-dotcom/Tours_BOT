...
- **Next safe order:**
  1. **Y38 (docs-first):** create a **supplier-intent** handoff/design **gate** before implementing supplier/RFQ/bridge behavior tied to **`need_supplier_offer`**; do **not** auto-notify or auto-contact suppliers from this intent without that gate.
