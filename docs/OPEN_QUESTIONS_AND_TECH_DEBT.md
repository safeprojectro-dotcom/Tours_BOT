...
- **Slice C1 / C1.1 / C2A / C2B1 / C2B2:** Telegram **private admin offer card** shows **`operator_workflow`** (**C1.1** compact copy **;** **C2A** read-only callbacks **;** **C2B1** packaging approve **;** **C2B2** packaging draft generate per paragraph above **;** **no** publish **/** bridge **/** activate **/** execution-link except future slices).
