...
- **Next** **(choose** **explicitly,** **not** **implied** **as** **approved** **):** **B7.3B** **stub** **/** **B7** **storage** **slice** **when** **ready** **;** **B11** **(deep** **links** **if** **product** **ready** **);** **B10.6** **(bot** **if** **priority** **);** **B12/B13** **further** **(showcase** **media** **`publish_safe`** **gate** **)** **when** **prioritized** **(** **read-only** **admin** **`GET /admin/supplier-offers/{id}/showcase-preview`** **—** **B13.4** **—** **done** **).** **Track** **3** **showcase** **—** **B12/B13** **first** **implementation** **slice** **+** **B13.1** **branded** **RO** **emoji** **template** **`supplier_offer_showcase_message`** **(still** **text-only**, **safe** **`supoffer`**/**Mini** **App** **CTAs**, **no** **channel** **`/tours/{code}`**, **no** **photo**) **done** **(see** **`CHAT_HANDOFF`** **).**
