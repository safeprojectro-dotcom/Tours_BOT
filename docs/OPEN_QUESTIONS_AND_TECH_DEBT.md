...
### Status
open (read-side **partially mitigated** for Phase 6 Step 1 list API, Steps 16–17 order-detail hints/preview, Step 18 handoff queue reads, and Steps **19–22** narrow handoff mutations; **section 1** remains open for semantics and non-projected consumers)
