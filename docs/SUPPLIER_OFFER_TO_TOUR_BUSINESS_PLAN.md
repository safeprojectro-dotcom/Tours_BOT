...
**Conversion chain (implementation reality, C2B9B):** Supplier offer **→** AI/admin packaging (`generate_packaging_draft`, `approve_packaging_for_publish`) **→** moderation **+** publish readiness (`GET …/review-package`, `conversion_closure`) **→** Telegram showcase publish **when** `publish_showcase_channel` **enabled** **(C2B8B)** **or** HTTP publish **→** **explicit** Tour bridge (`POST …/tour-bridge`, `create_tour_bridge`) **→** activate Tour for catalog when allowed (`activate_tour_for_catalog`, B8.3 guard) **→** create/activate execution link (`create_execution_link`; HTTP **or** Telegram link wizard when offer **`published`**) **→** **B11** `/start supoffer_<id>` **→** exact Mini App tour **only** when active execution link **+** `OPEN_FOR_SALE` **+** catalog visibility **→** Layer A reservation/payment. **Bridge/catalog** steps are **Admin** **API** today **(** **optional** Telegram product slices later **)** **;** ops order **for** bridge **vs.** channel publish **may** **vary**, **but** **execution** **link** **normally** **expects** **`published`** **lifecycle**.
...
**Slice C2B2 implemented:** Telegram adds **`generate_packaging_draft`** with mandatory confirmation **;** button only when action **`enabled`** **;** confirm **re-reads `GET …/review-package`** and executes **only** **`SupplierOfferPackagingService.generate_and_persist`** if still enabled **;** **does not** auto-approve packaging **(** **C2B1** separate **)** **;** cancel **no** mutation **;** refreshed card after success/error handling **.** Legacy **Aprobă / Respinge** unchanged **;** **no** **`approve_offer_moderation`** workflow button **;** **no** bridge **/** catalog activation **/** execution-link **via** **`operator_workflow`** **mutation** **buttons** **(those** **stay** **Admin** **API** **except** **existing** **Telegram** **execution-link** **wizard** **for** **`published`** **)** **;** **no** batch **.** **Showcase** **publish** **on** **Telegram** **:** **C2B8B** **( **`publish_showcase_channel`** **)** **. Possible next:** **`create_tour_bridge`** **/** **`activate_tour_for_catalog`** **on** **Telegram** **(product** **)** **;** **docs:** **C2B9B** **conversion** **chain** **sync** **.**

**Telegram Button UX Policy (accepted, docs-only):** Card is **not** a developer console **`;`** labels **1–2 words**, action/outcome oriented **`;`** **no** codes/endpoints/enums in button text **`;`** disabled workflow actions **hidden** **`;`** safe reads — **no** confirmation **`;`** safe mutations — **confirmation + re-read `review-package`** **`;`** preferred order **:** observe/read → packaging → legacy moderation → ops/navigation **`;`** **`publish_showcase_channel`** **shipped** **on** **Telegram** **as** **C2B8B** **(public_dangerous,** **double** **re-read** **)** **`;`** **`create_tour_bridge`**, **`activate_tour_for_catalog`**, **`create_execution_link`** **( **`operator_workflow`** **—** **)** **remain** **Admin** **API** **for** **materialization** **/** **catalog** **activation** **( **`create_execution_link`** **also** **via** **Telegram** **link** **wizard** **when** **offer** **`published`** **)** **`;`** **next** **optional** **product** **slices:** **Telegram** **bridge** **/** **activate** **buttons** **—** **explicit** **prompt** **only** **.** Label direction **:** **`review_package_refresh`** → **Actualizează / Refresh** **`;`** **`get_showcase_preview`** → **Preview** **`;`** **`generate_packaging_draft`** → **Generează text** or **Pregătește** **`;`** **`approve_packaging_for_publish`** → **Aprobă text / Aprobă pachet** **`;`** legacy moderation → **Aprobă oferta**, **Respinge oferta** **;** showcase publish → **Publică / Publish** **.**

**Slice C2B3 implemented:** Labels and **`_detail_keyboard`** row order only **`;`** subsequent slices add **packaging** **/** **media** **/** **showcase** **publish** **callbacks** **per** **C2B1–C2B8B **`;`** legacy moderation approve **`/`** reject disambiguated **`;`** **bridge** **/** **`activate-for-catalog`** **/** **execution-link** **( **`operator_workflow`** **)** **not** **on** **Telegram** **card** **except** **C2B8B** **publish** **and** **published-offer** **link** **UI** **.**
