...
4. **B12/B13** **—** **Telegram** **showcase** **(first** **slice** **implemented** **):** **deterministic** **text-only** **template** **`supoffer`** **bot** **CTA** **+** **soft** **Mini** **App** **link** **;** **further** **media** **`publish_safe`** **/** **preview** **endpoint** **deferred** **(** **`CHAT_HANDOFF`** **).**
