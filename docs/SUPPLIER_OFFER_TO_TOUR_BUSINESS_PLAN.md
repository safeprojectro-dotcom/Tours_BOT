...
**Slice C2B2 implemented:** Telegram adds **`generate_packaging_draft`** with mandatory confirmation **;** button only when action **`enabled`** **;** confirm **re-reads `GET …/review-package`** and executes **only** **`SupplierOfferPackagingService.generate_and_persist`** if still enabled **;** **does not** auto-approve packaging **(** **C2B1** separate **)** **;** cancel **no** mutation **;** refreshed card after success/error handling **.** Legacy **Aprobă / Respinge** unchanged **;** **no** **`approve_offer_moderation`** workflow button **;** **`create_tour_bridge`** **on** **Telegram** **—** **C2B10T-A** **(Link tour** **)** when **`enabled`** **`;`** **no** **`activate_tour_for_catalog`** **on** **card** **(** **Admin** **API** **/** **C2B10T-B** **)** **`;`** **no** execution-link **mutation** **button** **(** **HTTP** **/** **published-offer** **wizard** **)** **`;`** **no** batch **.** **Showcase** **publish** **:** **C2B8B** **.** **Next** **optional:** **C2B10T-B** **/** **C2B10T-C** **.**

**Telegram Button UX Policy (accepted, docs-only):** Card is **not** a developer console **`;`** labels **1–2 words**, action/outcome oriented **`;`** **no** codes/endpoints/enums in button text **`;`** disabled workflow actions **hidden** **`;`** safe reads — **no** confirmation **`;`** safe mutations — **confirmation + re-read `review-package`** **`;`** preferred order **:** observe/read → packaging → **Link tour** ( **C2B10T-A** **)** **→** legacy moderation → showcase / ops **`;`** **`publish_showcase_channel`** **—** **C2B8B** **(** **double** **re-read** **)** **`;`** **`create_tour_bridge`** **—** **C2B10T-A** **(** **double** **re-read** **)** **`;`** **`activate_tour_for_catalog`**, **`create_execution_link`** **materialization** **on** **card** **—** **Admin** **API** **/** **published-offer** **link** **wizard** **(** **optional** **C2B10T-B** **/** **C2B10T-C** **)** **.** Label direction **:** **`review_package_refresh`** → **Actualizează / Refresh** **`;`** **`get_showcase_preview`** → **Preview** **`;`** **`generate_packaging_draft`** → **Generează text** or **Pregătește** **`;`** **`approve_packaging_for_publish`** → **Aprobă text / Aprobă pachet** **`;`** **`create_tour_bridge`** → **Link tour / Leagă tur** **`;`** legacy moderation → **Aprobă oferta**, **Respinge oferta** **;** showcase publish → **Publică / Publish** **.**

**Slice C2B3 implemented:** Labels and **`_detail_keyboard`** row order only **`;`** subsequent slices add **packaging** **/** **media** **/** **showcase** **/** **bridge** **callbacks** **per** **C2B1–C2B8B** **and** **C2B10T-A** **`;`** legacy moderation approve **`/`** reject disambiguated **`;`** **`activate_tour_for_catalog`** **not** **on** **Telegram** **card** **(** **Admin** **API** **/** **C2B10T-B** **)** **`;`** **execution-link** **card** **mutation** **—** **published-offer** **UI** **/** **HTTP** **(** **optional** **C2B10T-C** **)** **.**
