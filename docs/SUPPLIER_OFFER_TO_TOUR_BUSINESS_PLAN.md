...
3. **B10.6** — **bot** as **router** **/** **consultant** **:** **slice** **1** **`/start` `tour_<code>`** **/** **tour-detail** **keyboard** **→** **Mini** **App** **`/tours/{code}`** **;** **slice** **B10.6B** **generic** **`/start`** **/** **`/tours`** **—** **router** **message** **no** **auto** **catalog** **cards** **(see** **`CHAT_HANDOFF`**, **`OPEN_QUESTIONS`** **).**
