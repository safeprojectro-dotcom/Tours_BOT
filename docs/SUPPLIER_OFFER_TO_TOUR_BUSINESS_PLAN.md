...
3. **B10.6** — **bot** as **router** **/** **consultant** **:** **first** **slice** **(** **`/start` `tour_<code>`** **+** **catalog** **tour** **detail** **→** **primary** **Mini** **App** **`/tours/{code}`** **WebApp** **)** **;** **broader** **router-first** **/** **`/start`** **catalog** **thinning** **deferred** **(see** [`docs/OPEN_QUESTIONS_AND_TECH_DEBT.md`](OPEN_QUESTIONS_AND_TECH_DEBT.md) **).**
