...
_STR: dict[str, dict[str, str]] = {
    "en": {
        ...
        "custom_request_intro": "This sends a structured request to suppliers — not a booking or payment. "
        "Someone may follow up in the bot chat or elsewhere.",
        ...
        "custom_request_field_route": "Route / destination / notes",
        ...
        "custom_request_success_title": "Request recorded",
        "btn_done": "Done",
        ...
        "my_requests_subtitle": "Status of your custom trip requests. Booking and payment still use the catalog flow unless a clear next step appears below.",
        "my_requests_loading": "Loading your requests…",
        "my_requests_empty": "You have no custom requests yet. You can submit one from Help.",
        "my_requests_row_view": "View details",
        "my_requests_row_followup_hint": "You may have a next step — open details.",
        "my_requests_row_review_hint": "No self-serve booking link yet — open details for status.",
        ...
        "my_requests_detail_status": "Status: {label}",
        ...
        "rfq_status_open": "Received",
        "rfq_status_under_review": "Under review",
        "rfq_status_supplier_selected": "Supplier selected",
        "rfq_status_closed_assisted": "Closed with assistance",
    ...
    "ro": {
        ...
        "custom_request_intro": "Trimite o cerere structurată către furnizori — nu este rezervare sau plată. "
        "Cineva te poate contacta ulterior în chatul botului sau altfel.",
        ...
        "custom_request_field_route": "Rută / destinație / note",
        ...
        "custom_request_success_title": "Cerere înregistrată",
        "btn_done": "Gata",
        ...
        "my_requests_subtitle": "Statusul cererilor personalizate. Rezervarea și plata rămân prin catalog decât dacă apare un pas clar mai jos.",
        "my_requests_loading": "Se încarcă cererile…",
        "my_requests_empty": "Încă nu ai cereri personalizate. Poți trimite una din Ajutor.",
        "my_requests_row_view": "Vezi detalii",
        "my_requests_row_followup_hint": "Poate exista un pas următor — deschide detaliile.",
        "my_requests_row_review_hint": "Încă fără link self-serve — deschide detaliile pentru status.",
        ...
        "rfq_status_open": "Primită",
        "rfq_status_under_review": "În revizie",
        "rfq_status_supplier_selected": "Furnizor selectat",
